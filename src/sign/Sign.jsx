...
export default function Sign() {
  ...
  return (
    <div className="signpage">
      <div className="signpage-title">
        서비스 이용을 위해
        <br />
        아래 <span className="bold-txt">항목에 동의</span>해주세요.
      </div>
      <div className="signpage-check-area">
        ...
        <div className="notice-open-btn" onClick={handleToggleChange}>
          <img
            src={`${isToggle ? "/images/toggle-up.png" : "/images/toggle.png"}`}
          />
        </div>
      </div>
      ...
      <div className="signpage-btn-area">
        <div
          ...
          className={`signpage-btn ${isChecked ? "btn-active" : ""}`}
        >
          동의하고 시작하기
        </div>
      </div>
