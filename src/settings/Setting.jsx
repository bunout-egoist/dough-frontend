...
export default function Setting() {
  ...
  return (
    <div>
      <div className={`signout-page ${signOutState ? "" : "signout-none"}`}>
        <div className="signout-pos">
          <div className="signout-box">
            <div>
              <img src="/images/setting/signout.png" className="img-width" />
            </div>
            <div className="signout-btn" onClick={ButtonSignout}>
              탈퇴하기
            </div>
            <div className="signout-exit" onClick={exitSignout}>
              취소
            </div>
          </div>
        </div>
      ...
      <div
        className={`setting-page page-area ${
          signOutState ? "signout-fixed" : ""
        }`}
      >
        ...
        <div className="setting-area">
              ...
              <Link to="/nickname">
                <div className="setting-service-li landing-nickname">
                  ...
                  <div className="vector-img">
                    <img alt="image" src="/images/vector.png" />
                  </div>
                </div>
              </Link>
              ...
              <div className="setting-alarm-box-2">
                <div className="setting-alarm-li">
                  <div className="flex-col">
                    <div className="setting-alarm-li-title">
                      데일리 퀘스트 알림
                    </div>
                    <div className="setting-alarm-li-subtitle">
                      오늘의 퀘스트가 도착했어요!
                    </div>
                  </div>
                  <div className="switch">
          ...
          <div className="setting-qa">
            ...
            <div className="setting-service-list">
              <Link
                to="https://bunout.notion.site/FAQ-2e83748986af483cb60f5d42f8ffa8ff?pvs=4"
                target="_blank"
              >
                <div className="setting-service-li">
                  <div>자주 묻는 질문들</div>
          ...
          <div className="setting-agency">
            ...
            <div className="setting-service-list">
              <Link
                to="https://bunout.notion.site/07affd8e5d464cd3ad5dd63e83bd9e38?pvs=4"
                target="_blank"
              >
                <div className="setting-service-li">
                  <div>서비스 이용약관</div>
              ...
              <Link
                to="https://bunout.notion.site/119f84e892f842f5b7b3ee86c97620ce?pvs=4"
                target="_blank"
              >
                <div className="setting-service-li">
                  <div>개인정보 처리방침</div>
          ...
          <div className="exit" onClick={showSignout}>
            탈퇴하기
          </div>
        </div>
      </div>
