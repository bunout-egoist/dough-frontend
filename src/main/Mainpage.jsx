...
export default function Mainpage() {
  ...
  // Determine if any mission with id >= 1 is checked
  const shouldShowRoundSlide = missions.some(
    (mission) => mission.isChecked && mission.id >= 1
  );

  return (
    <div className="mainpage page-area">
     {shouldShowRoundSlide && <RoundSlide />}
