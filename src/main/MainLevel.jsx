  ...
  return (
    <div className="main-levelpage">
      ...
      <div className="main-levelpage-top">
        ...
        <div className="level-top-img">
          <img
            className="img-width"
            src={`/images/main/type/${bunoutId}/0.png`}
          />
        </div>
        <div className="main-levelpage-level">
          <div className="level-value">
            {contents.currentExp}/{contents.requiredExp}
          </div>
          <div className="outer">
            <div
              className="inner"
      ...
      {contents && contents.attendanceCount !== undefined && (
        <div className="main-level-bottom">
          <div>
            <img
              src={`/images/main/level/day${contents.attendanceCount}.png`}
              className="img-width"
            />
          </div>
        </div>
